...
**Full-stack intelligent document workspace** — upload or camera-scan PDFs, DOCX, images and text files; extract content (OCR for scans); classify, summarize, extract structured fields; ask questions with citations; export JSON/CSV/Excel — backed by Supabase Auth + Storage and optional OpenAI.
...
| **JSON + CSV + Excel** export (single + bulk) | ✅ |
| **Human correction** of category / summary / fields | ✅ |
| **Original file preview** (signed URL) | ✅ |
...
2. Migrations under `supabase/migrations/` (see docs/setup-supabase.md)
...
| `GET` | `/documents/export.xlsx` | 🔒 | Export all as Excel |
| `GET` | `/documents/{id}` | 🔒 | Document detail |
| `GET` | `/documents/{id}/file-url` | 🔒 | Signed original-file URL |
